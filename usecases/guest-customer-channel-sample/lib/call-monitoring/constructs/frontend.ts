...
export class Frontend extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    const reactBuild = new NodejsBuild(this, 'ReactBuild', {
      assets: [
        {
          ...
          exclude: [
            ...
            '.*',
            '!usecases',
            '!usecases/guest-customer-channel-sample',
            '!usecases/guest-customer-channel-sample/lib',
            '!usecases/guest-customer-channel-sample/lib/call-monitoring',
            '!usecases/guest-customer-channel-sample/lib/call-monitoring/frontend',
            '!usecases/guest-customer-channel-sample/lib/call-monitoring/frontend/*',
            '!usecases/guest-customer-channel-sample/lib/call-monitoring/frontend/.*',
            '!usecases/guest-customer-channel-sample/lib/call-monitoring/frontend/**/*',
            '!usecases/guest-customer-channel-sample/lib/call-monitoring/frontend/**/.*',
            'usecases/guest-customer-channel-sample/lib/call-monitoring/frontend/dist',
            '!package*.json',
          ],
          commands: ['npm ci'],
        },
      ...
      distribution,
      outputSourceDirectory: 'usecases/guest-customer-channel-sample/lib/call-monitoring/frontend/dist',
    });
