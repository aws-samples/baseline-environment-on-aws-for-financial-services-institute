 ...
 * ECS cluster stack
 */
export interface ContainerBaseAppProps extends cdk.StackProps {
  myVpc: ec2.Vpc;
  appKey: kms.IKey;
  imageTag: string;
...
export class BaseApp extends Construct {
  ...
  constructor(scope: Construct, id: string, props: ContainerBaseAppProps) {
    super(scope, id);
